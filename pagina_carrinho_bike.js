...
function adicionar() {
    ...
    document.getElementById("574381").innerHTML = quantidade * document.getElementById("valorunitario").innerHTML;
}
...
function gravar(preco)
{
    ...
    var quantidadeElement = document.querySelector(".quantidade");
    var quantidade = parseInt(quantidadeElement.innerHTML);
    window.open ("gravar.php?codigo=" + codigo + "&quantidade=" + quantidade + "&preco="+preco , "_blank");
}